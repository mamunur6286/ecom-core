<?php include "inc/header.php"; ?>
    <div class="">
        <h5 style="margin-top: -8px;padding: 8px; border-radius: 3px" class=' text-center text-light font-weight-bold bg-primary'>Unseen Message List</h5>
    </div>
    ...
    <div class="card-body">
        <?php
            ...
            if ($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['seen_btn'])){
                ...
                $seenResult=$contact->seenMessage($messageId);
        ...
        <div  class="table-responsive">
            <table class="table table-bordered text-center">
                ...
                if(!empty($searchValue)){
                    ...
                    $getMsg=$contact->getUnseenMessage($start,$perPage);
                }
